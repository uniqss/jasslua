...
macro(DllImportDepends ModuleName ModulePath DependsLibList)
    MESSAGE(STATUS "DllImportDepends ${ModuleName} ${ModulePath} ${DependsLibList}")
    ...
    IF (IS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/${ModulePath})
        ...
        message("xxxx ${CMAKE_CURRENT_SOURCE_DIR}/${ModulePath}/")
        LINK_DIRECTORIES(${CMAKE_CURRENT_SOURCE_DIR}/${ModulePath}/../lib/)
        LINK_DIRECTORIES(E:/projects/wc/ulib/projects/lib/)
    
        FOREACH(DependsLib IN ITEMS ${DependsLibList})
            MESSAGE(STATUS "${DependsLib}")
            TARGET_LINK_LIBRARIES(${ModuleName} ${DependsLib})
        ENDFOREACH(DependsLib)
